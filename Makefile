...
SRCS = main.c src/exex_tools.c src/ft_errors.c src/builtins_commands.c src/more_tools.c src/edit_env.c src/utils.c src/export.c src/free_functions.c src/unset.c \
		src/execution_cmd.c src/get_cmdpath.c src/her_doc.c src/builtins_command2.c src/redc.files.c src/start_exec.c src/exec_tools.c src/tools0.c src/tools.c src/tools2.c src/tools3.c src/tools4.c \
